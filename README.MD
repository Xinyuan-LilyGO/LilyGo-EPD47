...
- Demotion to v 1.0.6 ESP32 board package, if you are using version 2.00,[refer to](https://github.com/Xinyuan-LilyGO/LilyGo-EPD47/issues/58#issuecomment-918260372)